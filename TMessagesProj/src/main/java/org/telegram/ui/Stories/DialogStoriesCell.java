...
//              }
        ...
        if (progress != 0) {
            ...
            final float statusAfterWidth = telegramLogoView.getVisibility() != VISIBLE
                    ? titleView.width()
                    : telegramLogoView.getMeasuredWidth();
            emojiStatusView.setTranslationX(titleView.getTranslationX() - dpf2(3.33f) + statusAfterWidth);
